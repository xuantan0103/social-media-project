  ...
  return (
    <React.Fragment>
      {isAccept && isAccept === "default" ? (
        ...
        <button style={{ backgroundColor: "rgba(0,128,128)", color: "white" }}>
          Bạn bè
        </button>
      )}
    </React.Fragment>
      ...
      <div className="menu-noti-container">
        <div className="menu-noti-main">
          <div className="menu-noti-title">
            ...
            <div className="menu-noti-title-control"></div>
          </div>
          <div
    ...
    <div className="menu-noti-container">
      <div className="menu-noti-main">
                  ...
                  <div className="menu-noti-content-avatar">
                    <Link to={"/profile/" + user.user_username}>
                      {user.user_avatar_cropX === null ? (
                        ...
                        <Image
                          cloudName="mohi-vn"
                          publicId={user.user_avatar + ".jpg"}
                          version="1607061343"
                        >
                          <Transformation
                            height={user.user_avatar_cropH}
                            width={user.user_avatar_cropW}
                            x={user.user_avatar_cropX}
                            y={user.user_avatar_cropY}
                            crop="crop"
                          />
                        </Image>
                      )}
        ...
        <div className="menu-noti-footer">
          <Link to="/friendrequests">See all</Link>
        </div>
      </div>
    </div>
  );
